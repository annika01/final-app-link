...
display(){
  ...
  this.complete.style("border-width", "3px")
  this.complete.style("font-size","35px")
  this.complete.style("border-radius","10px")


  this.complete.position(width/2-200,height/2)
